...
class GeorefPageContractTests(unittest.TestCase):
    ...
    def test_atlas_manual_export_is_unambiguously_unqualified(self):
        ...
        self.assertIn("Clustered cyan markers", javascript)
        ...
        self.assertIn('href="styles.css?v=20260722.5"', html)
        self.assertIn('src="app.js?v=20260722.6"', html)
        self.assertIn("source-photo-clustering.mjs?v=20260722.1", javascript)
        self.assertIn("Counts are clustered when zoomed out.", html)
        ...
        self.assertIn("iconSize: [68, 48]", javascript)
