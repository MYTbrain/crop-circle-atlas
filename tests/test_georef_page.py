...
class GeorefPageContractTests(unittest.TestCase):
    ...
    def test_atlas_manual_export_is_unambiguously_unqualified(self):
        ...
        self.assertIn("map.getPane('sourcePhotoPane').style.zIndex = '500'", javascript)
        ...
        self.assertIn('src="app.js?v=20260722.9"', html)
        ...
        self.assertIn("element.addEventListener('click', activate)", javascript)
        self.assertIn("element.addEventListener('keydown'", javascript)
