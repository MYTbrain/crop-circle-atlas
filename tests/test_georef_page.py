...
class GeorefPageContractTests(unittest.TestCase):
    ...
    def test_atlas_manual_export_is_unambiguously_unqualified(self):
        ...
        self.assertIn("radius: 5, color: '#f6ad55', weight: 2.25, opacity: 1, dashArray: '3 2'", javascript)
        self.assertIn("fillColor: '#f6ad55', fillOpacity: 0.08, renderer: localityRenderer", javascript)
        ...
        self.assertIn('href="styles.css?v=20260721.3"', html)
        self.assertIn('src="app.js?v=20260721.3"', html)
        self.assertIn("registered_overlays.json?v=20260721.3", javascript)
        self.assertIn("Five reviewed source-image placements are mapped", html)
